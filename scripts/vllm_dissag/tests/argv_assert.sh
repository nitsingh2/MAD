...
_has    "$O" "SimpleCPUOffloadConnector" "adds SimpleCPUOffloadConnector"
_has    "$O" "cpu_bytes_to_use" "SimpleCPUOffloadConnector has cpu_bytes_to_use"
...
_has    "$OD" "SimpleCPUOffloadConnector" "adds SimpleCPUOffloadConnector"
...
_hasnot "$N" "SimpleCPUOffloadConnector" "no SimpleCPUOffloadConnector when offload disabled"
